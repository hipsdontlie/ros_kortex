...
int main(int argc, char** argv){
  ...
  ros::Subscriber ee_marker_to_camera_sub_ = node_.subscribe<geometry_msgs::Transform>("/tf/eeMarkerToCameraCallback", 1, boost::bind(&baseToEEMarkerFrameCallback, _1, &ee_marker_to_camera_));
