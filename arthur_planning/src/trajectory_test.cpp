...
int main(int argc, char** argv)
{
  ...
  planning_components->setGoal(target_pose1, "EndEffector_Link");
  ...
  if (plan_solution1)
  {
    ...
    visual_tools.publishAxisLabeled(robot_start_state->getGlobalLinkTransform("EndEffector_Link"), "start_pose");
  ...
  if (plan_solution2)
  {
    ...
    visual_tools.publishText(text_pose, "Start Pose", rvt::WHITE, rvt::XLARGE);
    visual_tools.publishAxisLabeled(robot_state.getGlobalLinkTransform("EndEffector_Link"), "start_pose");
    visual_tools.publishText(text_pose, "Goal Pose", rvt::WHITE, rvt::XLARGE);
    visual_tools.publishAxisLabeled(target_pose1.pose, "target_pose");
  ...
  if (plan_solution4)
  {
    ...
    visual_tools.publishAxisLabeled(robot_state.getGlobalLinkTransform("EndEffector_Link"), "start_pose");
    visual_tools.publishText(text_pose, "Goal Pose", rvt::WHITE, rvt::XLARGE);
    visual_tools.publishAxisLabeled(robot_start_state->getGlobalLinkTransform("EndEffector_Link"), "target_pose");
